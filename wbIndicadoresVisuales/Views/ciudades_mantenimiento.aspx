<%@ Page Title="" Language="C#" MasterPageFile="~/Views/master.Master" AutoEventWireup="true" CodeBehind="ciudades_mantenimiento.aspx.cs" Inherits="wbIndicadoresVisuales.Views.ciudades_mantenimiento" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cphBody" runat="server">
    <div class="x_title">
        <h2>Ciudades <small>Mantenimiento</small></h2>
                        ...
                        <table class="table table-striped jambo_table table-hover table-bordered">
                            <thead>
                                <tr class="headings">
                                    ...
                                    <th class="column-title text-center">CIUDAD </th>
                                    <th class="column-title text-center">PAIS </th>
                                    <th class="column-title text-center"></th>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphHeader" runat="server">
    <script src="../Controllers/jsCiudad.js"></script>
</asp:Content>
                        ...
                        <div class="content">
                            <div class="row">
                                <div class="col-lg-6 form-group">
                                    ...
                                    <input type="text" class="form-control" id="txtCiudad" name="txtCiudad" placeholder="Ciudad" required="required">
                                </div>
                                <div class="col-lg-6 form-group">
                                    <label for="cbPais">Pais: </label>
                                    <select id="cbPais" style="width:100%;" class="select2_single form-control" name="cbPais" required="required"></select>
                                </div>
                            </div>
                        </div>
                    </form>
