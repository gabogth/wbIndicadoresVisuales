<%@ Page Title="" Language="C#" MasterPageFile="~/Views/master.Master" AutoEventWireup="true" CodeBehind="aerolineas_mantenimiento.aspx.cs" Inherits="wbIndicadoresVisuales.Views.aerolineas_mantenimiento" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cphBody" runat="server">
    <div class="x_title">
        <h2>Aerolínea <small>Mantenimiento</small></h2>
                        ...
                        <table class="table table-striped jambo_table table-hover table-bordered" data-show-toggle="false"">
                            <thead>
                                <tr class="headings">
                                    ...
                                    <th class="column-title text-center">Aerolinea </th>
                                    <th class="column-title text-center">COD </th>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphHeader" runat="server">
    <script src="../Controllers/jsAerolinea.js"></script>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="cphFooter" runat="server">
                        ...
                        <div class="content">
                            <div class="row">
                                <div class="col-lg-6 form-group">
                                    <label for="txtAerolinea">Aerolinea: </label>
                                    <input type="text" class="form-control" id="txtAerolinea" name="txtAerolinea" placeholder="Aerolinea" required="required">
                                </div>
                                <div class="col-lg-6 form-group">
                                    <label for="txtAbrev">Codigo: </label>
                                    <input type="text" class="form-control" id="txtAbrev" name="txtAbrev" placeholder="Codigo" required="required">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-6 form-group text-center">
                                    <img id="pbLogo" style="width: 128px; height: 64px;" display: block;" src="../images/unknowimage.png" alt="Imagen" />
                                    
                                </div>
                                <div class="col-lg-6 form-group">
                                    <label for="txtImagen">Logo: </label>
                                    <input type="file" class="form-control" id="txtImagen" name="txtImagen" required="required">
                                </div>
                            </div>
                            <div class="row" id="rowSumario">
                                <div class="col-lg-12 form-group">
                                    <p class="text-danger" id="lblSumario"></p>
                                </div>
                            </div>
                        </div>
                    </form>
    ...
    <div class="modal fade bs-example-modal-lg" id="viewImage" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">
                    ...
                    <h4 class="modal-title" id="imageTitulo"></h4>
                </div>
                <div class="modal-body">
                    <p class="text-center">
                        <img id="pbPreview" display: block;" src="../images/unknowimage.png" alt="Imagen" />
                    </p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal"><span class="fa fa-times"></span> Cerrar</button>
