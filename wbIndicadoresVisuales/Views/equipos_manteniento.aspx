<%@ Page Title="" Language="C#" MasterPageFile="~/Views/master.Master" AutoEventWireup="true" CodeBehind="equipos_manteniento.aspx.cs" Inherits="wbIndicadoresVisuales.Views.equipos_manteniento" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cphBody" runat="server">
    <div class="x_title">
        <h2>Equipos <small>Mantenimiento</small></h2>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div id="counter" class="text-right">
                        <input type="button" value="Actualizar Dispositivos" class="btn btn-primary" id="btnActualizar" name="btnActualizar" />
                        <input type="button" value="Reset Pagina" class="btn btn-primary" id="btnResetPagina" name="btnResetPagina" />
                    </div>
                        ...
                        <table class="table table-striped jambo_table table-hover table-bordered">
                            <thead>
                                <tr class="headings">
                                    ...
                                    <th class="column-title text-center">PASSWORD </th>
                                    <th class="column-title text-center"><span class="fa fa-refresh"></span></th>
                                    <th class="column-title text-center"><span class="fa fa-firefox"></span></th>
                                    <th class="column-title text-center"><span class="fa fa-bars"></span></th>
                                    <th class="column-title text-center"></th>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphHeader" runat="server">
    <script src="../Controllers/jsEquipos.js"></script>
                        ...
                        <div class="content">
                            <div class="row">
                                <div class="col-lg-6 form-group">
                                    ...
                                    <input type="text" class="form-control" id="txtNombre" name="txtNombre" placeholder="Nombre del equipo" required="required">
                                </div>
                                <div class="col-lg-6 form-group">
                                    <label for="txtIP">IP: </label>
                                    <input type="text" class="form-control" id="txtIP" name="txtIP" placeholder="IP del equipo" required="required">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-6 form-group">
                                    <label for="txtUsuario">Usuario del equipo: </label>
                                    <input type="text" class="form-control" id="txtUsuario" name="txtUsuario" placeholder="Usuario del equipo" required="required">
                                </div>
                                <div class="col-lg-6 form-group">
                                    <label for="txtPW">Password del equipo: </label>
                                    <input type="text" class="form-control" id="txtPW" name="txtPW" placeholder="Password del equipo" required="required">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-6 form-group">
