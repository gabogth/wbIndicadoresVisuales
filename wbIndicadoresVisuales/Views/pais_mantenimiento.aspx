<%@ Page Title="" Language="C#" MasterPageFile="~/Views/master.Master" AutoEventWireup="true" CodeBehind="pais_mantenimiento.aspx.cs" Inherits="wbIndicadoresVisuales.Views.pais_mantenimiento" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cphBody" runat="server">
    <div class="x_title">
        <h2>Pais <small>Mantenimiento</small></h2>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphHeader" runat="server">
    <script src="../Controllers/jsPais.js"></script>
</asp:Content>
                        ...
                        <div class="content">
                            <div class="row">
                                <div class="col-lg-6 form-group">
                                    ...
                                    <input type="text" class="form-control" id="txtPais" name="txtPais" placeholder="Pais" required="required">
                                </div>
                                <div class="col-lg-6 form-group">
