<%@ Page Title="" Language="C#" MasterPageFile="~/Views/master.Master" AutoEventWireup="true" CodeBehind="faja_mantenimiento.aspx.cs" Inherits="wbIndicadoresVisuales.Views.faja_mantenimiento" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cphBody" runat="server">
    <div class="x_title">
        <h2>Faja <small>Relaciones</small></h2>
                        ...
                        <table class="table table-striped jambo_table table-hover table-bordered">
                            <thead>
                                <tr class="headings">
                                    ...
                                    <th class="column-title text-center">FAJA </th>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphHeader" runat="server">
    <script src="../Controllers/jsFajaRel.js"></script>
</asp:Content>
                        ...
                        <div class="content">
                            <div class="row">
                                <div class="col-lg-6 form-group">
                                    <label for="txtFaja:number">Faja: </label>
                                    <input type="number" name="txtFaja:number" id="txtFaja" class="form-control" required="required" />
                                </div>
                                <div class="col-lg-6 form-group">
