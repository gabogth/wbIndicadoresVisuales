<%@ Page Title="" Language="C#" MasterPageFile="~/Views/master.Master" AutoEventWireup="true" CodeBehind="estado_mantenimiento.aspx.cs" Inherits="wbIndicadoresVisuales.Views.estado_mantenimiento" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cphBody" runat="server">
    <div class="x_title">
        <h2>Estado <small>Mantenimiento</small></h2>
                        ...
                        <table class="table table-striped jambo_table table-hover table-bordered" data-show-toggle="false">
                            <thead>
                                <tr class="headings">
                                    ...
                                    <th class="column-title text-center">ESTADO [ES] </th>
                                    <th class="column-title text-center">ESTADO [EN] </th>
                                    <th class="column-title text-center">COLOR </th>
                                    <th class="column-title text-center"></th>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphHeader" runat="server">
    <script src="../Controllers/jsEstado.js"></script>
</asp:Content>
                        ...
                        <div class="content">
                            <div class="row">
                                <div class="col-lg-6 form-group">
                                    <label for="txtEstadoES">Estado Español: </label>
                                    <input type="text" class="form-control" id="txtEstadoES" name="txtEstadoES" placeholder="Estado español" required="required">
                                </div>
                                <div class="col-lg-6 form-group">
                                    <label for="txtEstadoEN">Estado Español: </label>
                                    <input type="text" class="form-control" id="txtEstadoEN" name="txtEstadoEN" placeholder="Estado ingles" required="required">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-6 form-group">
                                    <label for="cbColor">Color: </label>
                                    <select id="cbColor" name="cbColor" class="form-control">
                                        <option value="#1a681c">VERDE</option>
