<%@ Page Title="" Language="C#" MasterPageFile="~/Views/master.Master" AutoEventWireup="true" CodeBehind="rol_mantenimiento.aspx.cs" Inherits="wbIndicadoresVisuales.Views.rol_mantenimiento" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cphBody" runat="server">
    <div class="x_title">
        <h2>Rol <small>Mantenimiento</small></h2>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphHeader" runat="server">
    <script src="../Controllers/jsRol.js"></script>
</asp:Content>
                        ...
                        <div class="content">
                            <div class="row">
                                <div class="col-lg-12 form-group">
                                    ...
                                    <input type="text" class="form-control" id="txtRol" name="txtRol" placeholder="Rol" required="required">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-12">
