<%@ Page Title="" Language="C#" MasterPageFile="~/Views/master.Master" AutoEventWireup="true" CodeBehind="usuario_mantenimiento.aspx.cs" Inherits="wbIndicadoresVisuales.Views.usuario_mantenimiento" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cphBody" runat="server">
    <div class="x_title">
        <h2>USUARIO <small>Mantenimiento</small></h2>
                        ...
                        <table class="table table-striped jambo_table table-hover table-bordered" data-show-toggle="false"">
                            <thead>
                                <tr class="headings">
                                    ...
                                    <th class="column-title text-center">TELEFONO </th>
                                    <th class="column-title text-center">ROL </th>
                                    <th class="column-title text-center"></th>
                                    <th class="column-title text-center"><span class="fa fa-key"></span></th>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphHeader" runat="server">
    <script src="../Controllers/jsUsuario.js"></script>
</asp:Content>
                        ...
                        <div class="content">
                            <div class="row">
                                <div class="col-lg-6 form-group">
                                    ...
                                    <input type="text" class="form-control" id="txtUsuario" name="txtUsuario" placeholder="Usuario" required="required">
                                </div>
                                <div class="col-lg-6 form-group" id="dvPassword">
                            ...
                            <div class="row">
                                <div class="col-lg-6 form-group">
                                    ...
                                    <input type="text" class="form-control" id="txtNombre" name="txtNombre" placeholder="Nombre" required="required">
                                </div>
                                <div class="col-lg-6 form-group">
                                    <label for="txtApellido">Apellido: </label>
                                    <input type="text" class="form-control" id="txtApellido" name="txtApellido" placeholder="Apellido" required="required">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-6 form-group">
                                    <label for="txtTelefono">Teléfono: </label>
                                    <input type="text" class="form-control" id="txtTelefono" name="txtTelefono" placeholder="Telefono" required="required">
                                </div>
                                <div class="col-lg-6 form-group">
                                    <label for="cbRol:number">Rol: </label>
                                    <select id="cbRol" style="width:100%;" class="select2_single form-control" name="cbRol:number" required="required"></select>
                                </div>
                            </div>
                        </div>
                    </form>
