<%@ Page Title="" Language="C#" MasterPageFile="~/Views/master.Master" AutoEventWireup="true" CodeBehind="fids_relacionar.aspx.cs" Inherits="wbIndicadoresVisuales.Views.fids_relacionar" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cphBody" runat="server">
    <div class="x_title">
        <h2>FIDS <small>Relaciones</small></h2>
                        ...
                        <table class="table table-striped jambo_table table-hover table-bordered">
                            <thead>
                                <tr class="headings">
                                    ...
                                    <th class="column-title text-center">I/O </th>
                                    <th class="column-title text-center"></th>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphHeader" runat="server">
    <script src="../Controllers/jdFidRel.js"></script>
</asp:Content>
                    ...
                    <form id="frmInsertar">
                        <div class="content">
                            <div class="row">
                                ...
                                <div class="col-lg-6 form-group">
                                    <label for="cbIO:number">Tipo</label>
                                    <select id="cbIO" name="cbIO:number" class="form-control">
                                        <option value="0" selected="selected">SALIDA</option>
