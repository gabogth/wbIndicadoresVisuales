<%@ Page Title="" Language="C#" MasterPageFile="~/Views/master.Master" AutoEventWireup="true" CodeBehind="vuelos_mantenimiento.aspx.cs" Inherits="wbIndicadoresVisuales.Views.vuelos_mantenimiento" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cphBody" runat="server">
    <div class="x_title">
        <h2>Vuelos <small>Mantenimiento</small></h2>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphHeader" runat="server">
    <script src="../Controllers/jsVuelos.js"></script>
</asp:Content>
                        ...
                        <div class="content">
                            <div class="row">
                                <div class="col-lg-6 form-group">
                                    <label for="txtVuelo">Nro. Vuelo: </label>
                                    <input type="text" class="form-control" id="txtVuelo" name="txtVuelo" placeholder="Número de vuelo" required="required">
                                </div>
                                <div class="col-lg-6 form-group">
                                    <label for="cbAerolinea">Aerolinea: </label>
                                    <select id="cbAerolinea" style="width:100%;" class="select2_single form-control" name="cbAerolinea" required="required"></select>
                                </div>
                            </div>
                        </div>
                    </form>
